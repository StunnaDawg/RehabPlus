...
const UpdateWorkoutsButton = ({title, description, exercises, setOnAppear}) => {
  ...
  return (
    <Button
      ...
      ])); setNewWorkoutData([]); setExerciseWorkoutData([]); navigation.navigate("NewProtocol"); setOnAppear(true) }}
    >
      Update Workout
    </Button>
  )
