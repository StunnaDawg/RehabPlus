...
export type ExerciseContextTyping = ExercisesContextType & ExercisesContextAction

type ExerciseContextProviderProps = {
  children: React.ReactNode
}

const ExerciseContext = createContext<ExerciseContextTyping | undefined>(undefined)
...
export const useExerciseContext = (): ExerciseContextTyping => {
  ...
  if (!context) {
      throw new Error('ExerciseContext must be used within the ExerciseContextProvider');
  }
  return context;
};
